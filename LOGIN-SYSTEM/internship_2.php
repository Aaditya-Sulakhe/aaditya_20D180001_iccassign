 ...
 if(isset($_SESSION['id']) && isset($_SESSION['userName']) && isset($_SESSION['fullName']) && isset($_SESSION['email']))
  {
    ...
    if(!$conn)
    ...
    else
     {
       ...
       $sqlQuery = "SELECT * FROM internship_2 WHERE userName = '$userName'";
       $result = mysqli_query($conn,$sqlQuery);

       if(mysqli_num_rows($result)>0)
        {
          header("Location:home.php?msg=You have already applied for internship_2.");
          exit();
        }
       else
        {
  ...
  $uploads_dir = 'Resumes';
      ...
      $sqlQuery2 = "INSERT INTO internship_2(fullName, userName, email, resume) VALUES ('$fullName','$userName','$email', '$filename')";
